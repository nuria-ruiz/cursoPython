...
SELECT * from libros;
INSERT into usuario(nombre, clave) values("Oscar", "1234");
SELECT nombre from usuario;
SELECT nombre, clave from usuario limit 1;
use ejemplo;
...
SELECT * from libros order by titulo limit 2;
...
SELECT * from libros;
delete from libros where codigo = 11;
